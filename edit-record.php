                    ...
                    <section class="col-sm-4 row text-center">
                        ...
                        <form class="col-sm-10 mt-5" action="" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <p class="">If you don't want to change the photo, <br></br><button name="canceladd" class="btn btn-dark btn-sm" type="submit"> Finish</button></p>
                                <input id="file" class="form-control-file" type="file" name="file">
                                <small class="help-block">Only png and jpg files are allowed!</small>
                            </div>

                            <button type="submit" name="addimage" class="btn btn-info btn-block">Update </button>
                        </form>
                        <div class="col-sm"></div>
                    </section>
                </section>
